...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🥇 sᴜᴘᴘᴏʀᴛ 🥇', url=f"https://t.me/Oxyver_Support")
                ],[
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🤖 𝖩𝗈𝗂𝗇 𝖴𝗉𝖽𝖺𝗍𝖾𝗌 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 🤖", url='https://urlsopen.net/ce4n'
                )
            ],[
                InlineKeyboardButton(
                    "‼️How To Join Updates Channel?", url='https://t.me/Tollywood_Dubbed_Movies_2/4450'
                )
              ]
        ]
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝖯𝖨𝖱𝖮 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url="https://t.me/Oxyver") ] ] ),
